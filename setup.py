...
setup(name='ask_amy',
      ...
      license='MIT',
      packages=['ask_amy', 'ask_amy.cli', 'ask_amy.cli.code_gen', 'ask_amy.core', 'ask_amy.services','ask_amy.database', 'ask_amy.state_mgr', 'ask_amy.utilities'],
      package_data={'ask_amy': ['cli/code_gen/templates/*.tmpl']},
